...
namespace PVPNetConnect
{
    public partial class PVPNetConnection
    {
        ...
        private bool SendConnect()
        {
            ...
            isConnected = true;
            if (OnConnect != null)
                new Thread(() => OnConnect(this, EventArgs.Empty)).Start();
        ...
        public void Disconnect()
        {
            Thread t = new Thread(() =>
            {
                ...
                if (OnDisconnect != null)
                    new Thread(() => OnDisconnect(this, EventArgs.Empty)).Start();
            });
        ...
        private void Error(string message, string errorCode, ErrorType type)
        {
            ...
            if (OnError != null)
                new Thread(() => OnError(this, error)).Start();
        }
                                        ...
                                        new Thread(new ThreadStart(() =>
                                           {
                                               ...
                                               else if (body.type.Equals("com.riotgames.platform.reroll.pojo.StoreAccountBalanceNotification"))
